...
export default function PaymentModal({onclose}) {
  ...
  return (
    <div className='w-screen h-screen fixed top-0 left-0 flex justify-center items-center backdrop-blur-xl z-[100]'>
      <div className="fixed bg-white rounded-lg shadow-lg p-10 w-full max-w-4xl">
