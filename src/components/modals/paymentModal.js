...
export default function PaymentModal({ onclose }) {
  ...
  return (
    <div
      className="w-screen h-full sm:h-screen fixed top-0 text-black left-0 flex font-aclonica justify-center items-center backdrop-blur-xl z-[100] overflow-auto"
      data-aos="fade-in"
    >
      <div
        className="fixed h-auto max-h-[90vh] overflow-y-auto m-4 sm:m-10 bg-white rounded-lg shadow-lg p-4 sm:p-10 w-[95%] sm:w-[90%] max-w-4xl"
        data-aos="zoom-in"
      >
        <div className="flex justify-between items-center py-3 sm:py-5">
          <h2 className="text-xl sm:text-2xl font-bold">Payment Method</h2>
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-around gap-3 mt-4">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-center">Credit card</p>
              {selectedMethod === 'creditCard' && (
                <div className="text-green-500 mt-1 sm:mt-2">✔</div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  readOnly
                />
                <div className="absolute right-4 top-8 sm:top-10 text-lg sm:text-xl">
                  VISA
                </div>
                <div className="absolute right-12 sm:right-14 top-8 sm:top-10 text-green-500">
                  ✔
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  readOnly
                />
                <div className="absolute right-4 top-8 sm:top-10 text-gray-500">
                  📅
                </div>
              </div>
